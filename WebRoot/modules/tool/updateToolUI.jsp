...
<html>
	...
	<body>
		...
		<div class="project_pop">
			...
			<div class="bd">
				<s:form theme="simple" action="updateTool">
					...
					<table>
						<tbody>	
							<tr>
								<th>工具名字：</th>
								<td>
									<s:textfield name="model.toolName" />
								</td>
							</tr>
							<tr>
								<th>编号与型号：</th>
								<td>
									<s:textfield name="model.toolNo" />
								</td>
							</tr>
							<tr>
								<th>数量：</th>
								<td>
									<s:textfield name="model.toolNum" />
								</td>
							</tr>
							<tr>
								<th>归属地区：</th>
								<td>
									<s:select list="#{1:'旅顺',2:'本部'}" listKey="key" listValue="value"  name="model.toolPlace" />
								</td>
							</tr>
							<tr>													
					...
					<s:hidden name="model.userKey"/>
					<s:hidden name="model.toolOut" />
				</s:form>
			</div>
		</div>
	</body>
