...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String actionName = "listUser.action";			
%>
<html>
	<head>
		<title>用户管理</title>
		...
		<script type="text/javascript">	
			...
			var vDialog;
			function addEntity() {
				var addUrl = "url:<%=basePath%>inputUser.action";
				 vDialog = $.dialog({
					id: 'addWin',
					title: '用户管理',
					lock: true,
			...
			function editEntity(entityKey) {
				var editUrl = "url:<%=basePath%>inputUser.action?key=" + entityKey;
				var vDialog = $.dialog({
					id: 'editWin',
					title: '用户管理',
					lock: true,
			...
			function listEntity() {			  
				document.forms[0].action = "<%=basePath%>listUser.action";			   
				document.forms[0].submit();	
			}
			
			function toResume(entityKey) {
				document.forms[0].action = "<%=basePath%>listResume.action?model.userKey="+entityKey;		   
				document.forms[0].submit();	
			}
		</script>
	</head>
			...
			<div id="main" class="ks-clear">
				...
				<div id="mi_container">
					<div class="module_01">
						...
						<div class="h20"></div>
						<div class="btn_list">
							<input type="button" class="I_btn_02" onclick="addEntity();" value="添加用户"/>
						</div>
						<div class="bd">
							<div class="info_list">
										...
										<tbody>											
											<s:iterator value="entities">
												<tr>
													...
													<td><s:property value="service.getRoleNameByUserKey(id)" /></td>
													...
													<td width="120">
														...
														<a href='deleteUser.action?key=<s:property value="id" />'>删除</a>
													</td>
												</tr>
											</s:iterator>
										</tbody>
