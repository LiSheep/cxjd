...
<html>
	...
	<body>
		...
		<s:form theme="simple" action="updateReportNews">
						...
						<div class="bd">
							...
							<table>
								...
								<tr>
									<td></td>
									<td>
										<input type="button" class="I_btn_02" onclick="subEntity()" value="修改"/>
										<input type="button" class="I_btn_02" onclick="window.location.href='<%=basePath%>listReportNews.action'" value="取消"/>
									</td>
								</tr>
							</table>
						</div>
