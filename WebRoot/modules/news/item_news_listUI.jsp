...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String actionName = "listItemNews.action";	
%>
<html>
	<head>
		<title>项目介绍文件<s:if test="#session.role==1 || #session.role==3">管理</s:if></title>
		...
		<script type="text/javascript">	
			...
			function listEntity() {			  
				document.forms[0].action = "<%=basePath%>listItemNews.action";			   
			...
			<div id="main" class="ks-clear">
				...
				<div id="mi_container">
					<div class="module_01">
						...
						<div class="btn_list">
							<input type="button" class="I_btn_02" onclick="window.location.href='<%=basePath%>inputItemNews.action'" value="添加"/>
						</div>
						</s:if>
						<div class="bd">
							<div class="info_list">
									...
									<table width="100%">
										...
										<tbody>											
											<s:iterator value="entities">
												<tr>
													<td>
														<a href='detailItemNews.action?key=<s:property value="id" />'>
													...
													<s:if test="#session.role==1 || #session.role==3">
													<td width="120">
														<input type="button" class="I_btn_01" onclick="window.location.href='<%=basePath%>inputItemNews.action?key=<s:property value="id" />'" value="修改"/>
														<a href='deleteItemNews.action?key=<s:property value="id" />'>删除</a>
													</td>
													</s:if>
												</tr>
											</s:iterator>
