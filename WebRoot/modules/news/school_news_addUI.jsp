...
<html>
	...
	<body>
		...
		<s:form theme="simple" action="addSchoolNews">
			...
			<div id="main" class="ks-clear">
				...
				<div id="mi_container">
					<div class="module_01">
						...
						<div class="bd">
							<s:hidden name="model.newsType" value="1" />
							<table>
								...
								<tr>
									...
									<td>
										...
										<input type="button" class="I_btn_02" onclick="window.location.href='<%=basePath%>listSchoolNews.action'" value="取消"/>
									</td>
								</tr>
							</table>
						</div>
