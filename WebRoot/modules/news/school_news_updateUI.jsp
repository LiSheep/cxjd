...
<html>
	...
	<body>
		...
		<s:form theme="simple" action="updateSchoolNews">
					...
					<div class="module_01">
						...
						<div class="bd">
							...
							<table>
								...
								<tr>
									<td></td>
									<td><input type="button" class="I_btn_02" onclick="subEntity()" value="修改"/>
									<td><input type="button" class="I_btn_02" onclick="window.location.href='<%=basePath%>listSchoolNews.action'" value="取消"/></td>
								</tr>
							</table>
						</div>
						<div class="h20"></div>
